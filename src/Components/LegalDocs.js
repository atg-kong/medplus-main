  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
          MED <span className="legal-siteSign">+</span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Med Plus, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Med Plus, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Med Plus is designed to simplify healthcare access. You can choose
